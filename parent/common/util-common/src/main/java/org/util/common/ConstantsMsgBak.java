...
public class ConstantsMsgBak {
	
	/**测试使用*/
	public static void main(String[] args) {
		
		String str2 = ConstantsMsgBak.MSG_002;
	 ...
	 * 用户注册成功
	 */
	public static  String MSG_001 = "亲，您已经成功注册为中美家网会员啦！在这里，您可以找到最称心的装修公司；装修精英版块可以找到最专业的设计师、工长和散工；建材家居城有琳琅满目的建材、家具供您选购；所有精品设计、装修美图尽在成功案例；新手学装修必进知识库。这里的一切，只为让您体验到最轻松、最便捷、最安心的装修之旅。"; 
	 ...
	 * @param cname ->装修公司名称<br>
	 */
	public static final String MSG_009 = "亲，您已选择了【cname】为您装修，尽快支付定金开始施工吧！";

	/**
	 * 用户支付定金<br>
	 * @param cname ->装修公司名称<br>
	 */
	public static final String MSG_010 = "您已成功为【cname】支付定金，将尽快根据合同开始施工。我们会在每个施工阶段上传装修日志，记得随时查看您的装修日记哦。";
	 ...
	 * @param project ->项目名称
	 */
	public static final String MSG_013 = "亲，您的\"【project】\"项目已经全部施工完成啦！快去验收吧，没问题的话快支付尾款，搬新家啦！别忘了对装修公司评价哦。";
	 ...
	 * @param code ->订单编号
	 */
	public static final String MSG_036 = "订单号为：【code】的用户已支付定金啦，请注意查收。尽快根据合同开始施工吧！";
	 ...
	 * @param code ->订单编号
	 */
	public static final String MSG_038 = "订单号为：【code】的用户已支付尾款，请注意查收。";
	 ...
	 * @param num ->阶段数
	 */
	public static final String MSG_045 = "订单号为：【code】的用户，已支付第【num】阶段费用啦！快根据协议设计并提交阶段内容吧！";
